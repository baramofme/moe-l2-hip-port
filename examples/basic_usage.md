...
- 多架构二进制（bins-v0.4.0）：GTX 1080 → RTX 50 系一个包全支持；2080 Ti 全链路实测 DS-V2-Lite **87.25** / Qwen3.6-A3B **47.24 t/s**（bins-v0.4.0 + selective pin，2026-08-10），见 [multi-arch-three-gpu-benchmark.md](../references/zh/multi-arch-three-gpu-benchmark.md)
