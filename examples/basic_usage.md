...
- 多架构二进制（bins-v0.2.0）：GTX 1080 → RTX 50 系一个包全支持（2080 Ti 6.89 / 3080 Ti 12.25 / 5090 16.63 t/s，DS-V2-Lite），见 [multi-arch-three-gpu-benchmark.md](../references/multi-arch-three-gpu-benchmark.md)
