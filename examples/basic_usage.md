...
- 实测（RTX 4090）：DS-V2-Lite 37.5 t/s @ 1.6 GB、Qwen3.6-A3B 46.8 t/s @ 2.1 GB
- 多架构二进制（bins-v0.4.0）：GTX 1080 → RTX 50 系一个包全支持；2080 Ti 全链路实测 DS-V2-Lite **87.25** / Qwen3.6-A3B **47.24 t/s**（bins-v0.4.0 + selective pin，2026-08-10），见 [multi-arch-three-gpu-benchmark.md](../references/multi-arch-three-gpu-benchmark.md)
