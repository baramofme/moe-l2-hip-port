...
**moe-l2 在 RTX 4090 上用 bins-v0.4.0 跑 DeepSeek V4 Flash（UD-IQ2_M，85GB 三片）达到 35.96 t/s（on-demand 兜底，RSS 17.5GB）/ 34.67 t/s（selective pin，RSS 26.8GB），VRAM 16.5-16.7GB**（2026-08-10 实测，完整 4 轮数据见文末"08-10 复测"节）。此前 2080 Ti（11G）/ RTX 3080（10G）v3.1 全链路 0.89-2.22 t/s（卡算力极限）。
...
**实测（短上下文，c=512）**：RTX 4090 + moe-l2（on-demand pin + A3 cache 2048）下 **10.1 t/s**（2026-08-07，原版二进制口径；08-10 bins-v0.4.0 实测 35.96 t/s）；2080 Ti / RTX 3080（v3.1 全链路）0.89-2.22 t/s。
