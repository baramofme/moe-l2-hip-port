...
> **Long-context (c=8192) measurements — 2026-08-14 fixed build (bins-v0.4.1, RTX 4090)**: Qwen3.6-A3B **39.6-42.7 t/s @ ~8.9 GB**, DS-V2-Lite **119.0-123.6 t/s @ ~10.1 GB** (8K long generation + follow-up; the old 08-09 v5 figures 45.1/34.1 t/s were P0-void). 8K context + long generation is closer to real usage; short-context short-generation reaches the 44-48 / 133.2 t/s in the table above. Raw sampling data and full generated text are in the demo asset package (rec_data.csv / rec_full.txt).
