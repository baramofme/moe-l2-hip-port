...
## 最新成果（2026-08-10）：三卡全链路复测（bins-v0.4.0 / selective pin）

> 用 bins-v0.4.0 多架构二进制 + 全链路（`moe-l2 start --gpu`，selective pin 路由表 top-100）在 RTX 2080 Ti / 4090 / 5090 三卡复测。相比官方原版 llama.cpp 二进制（6.89-16.63 t/s 级别）+288%~+1166%，进一步确认 moe-l2 优化版真实性能。
...
**RTX 4090**（bjb1 云机，bins-v0.4.0 修复版）：
...
- 稳定值：2080 Ti ~82-87、4090 ~128-146、5090 ~119-153 t/s；报告取 round3 追问1
...
2. **5090 上 DS 全链路 135.57 t/s**（vs 原版 llama.cpp 16.63 t/s ≈ +715%，2026-08-10 同机补充实测，round3 追问1；短对话 118.53 / 追问2 152.88）——moe-l2 优化释放 Blackwell 真实性能
3. **4090 上 DS 全链路 145.63 t/s**（vs 08-02 单架构基线 37.5 t/s ≈ +288%，2026-08-10 修复版实测，round3 追问1；短对话 134.05 / 追问2 127.95；VRAM 4.9GB、RSS 2.1GB）——sm_89 Ada 内核最成熟，4090 反超 5090
4. **selective pin 零拖累**：路由表 top-100 pin 后 2080 Ti 速度稳定
5. **冷启动明显**：round1 短对话 39.62 → round2 81.67（首次加载路由表 + 专家 pin + GPU cache 预热），round2 起即达稳定
