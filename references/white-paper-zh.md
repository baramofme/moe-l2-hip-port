...
| V4-Flash（157B/85GB，4090） | OOM | **10.1 t/s** | 原 1.7-2.0 提升 5 倍 |
...
| 4 | **on-demand pin（08-07 当前主线）** | 1.6-2.9 GB | **Qwen 50.2 / DS 37.9 / V4 10.1 t/s** | ✅ 已验证（当前主线） |
...
| **V4-Flash** | **on-demand pin + cache 2048（08-07）** | — | **10.1** | **17.4 GB** |

- DS-V2-Lite：速度 **+200%**（12.5 → 37.9 t/s），显存几乎不变
- Qwen3.6-A3B：速度 **+400%**（10 → 50.2 t/s，超 pre-lazy 46.5）
- V4-Flash：**5 倍提速**（1.7-2.0 → 10.1 t/s），4090 上 GPU util 13% → 86%（近计算 bound）
