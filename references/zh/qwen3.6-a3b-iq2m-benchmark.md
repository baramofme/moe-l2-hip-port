...
> 用 bins-v0.4.0 多架构二进制 + 全链路（`moe-l2 start --gpu`，selective pin 路由表 top-100）在 RTX 2080 Ti / 4090 / 5090 三卡复测。相比官方原版 llama.cpp 二进制（9.71-11.15 t/s 级别）+60%~+687%，进一步确认 moe-l2 优化版真实性能。
...
- 稳定值：2080 Ti ~41-47、4090 ~64-75、5090 ~66-76 t/s；报告取 round3 追问1
