...
\*\* 4090/2080 Ti/5090 数据为 **2026-08-16 bins-v0.5.0 + C 方案全链路实测**（按领域换表，`moe-l2 start --gpu`）；5090 为真实 SM120a 数据，替换作废的 P0 假速度；3080 Ti 仍为 v3.1 多架构口径（bins-v0.3.0）。
...
\* 4090/2080 Ti/5090 为 **2026-08-16 bins-v0.5.0 + C 方案全链路实测**（按领域换表）；5090 为真实 SM120a 数据（替换 P0 假速度 135.57/76.41）；3080 Ti 为 v3.1 多架构包（bins-v0.3.0）实测。
