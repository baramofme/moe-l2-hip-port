...
> **长上下文补充实测（2026-08-09，v5 默认 whole-pin，RTX 4090，-c 8192，3200 tokens 长生成）**：Qwen3.6-A3B **45.1 t/s @ 2.4 GB（2477 MiB）**、DS-V2-Lite **34.1 t/s @ 3.4 GB（3441 MiB）**——⚠️ P0 假速度嫌疑，待重测；短上下文短生成见上表 133.2 / 44-48 t/s（2026-08-14 bins-v0.4.1 修复版实测）。原始采样数据与生成全文见演示素材包（rec_data.csv / rec_full.txt）。
